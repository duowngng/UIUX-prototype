...
const OverviewContent: React.FC<CycleProps> = (props) => {
  ...
  return (
    <>
      <MantineProvider>
        <section className="grid w-full grid-cols-1 gap-4 gap-x-4 transition-all sm:grid-cols-2 xl:grid-cols-3 justify-between mb-4">
          <CardContent className="grid content-between">
            ...
            <section className="align-bottom flex flex-col gap-1">
              ...
              <div className="flex gap-4 items-center">
                ...
                <p className="truncate text-xs">
                  Chu kì :{fromDateFormatted} đến {toDateFormatted}
                </p>
              </div>
            </section>
          </CardContent>
